...
//    EditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t2_city = findViewById(R.id.textView2);
        t3_description = findViewById(R.id.textView3);
        t4_date = findViewById(R.id.textView4);
        find_weather();
    }
    public void find_weather()
    {
        String url = "https://api.openweathermap.org/data/2.5/weather?q=Москва&appid=929352fe65923fe408295e281c24b9ff";
